$(function () {
    ...
    if (window.location.hash) {
        $(window.location.hash).css('background-color', themeColors.highlightBgColor).parent().animate({
            backgroundColor: themeColors.bgColor
        },
            2000);

        $('*[name=' + window.location.hash.substr(1) + ']').parent().css('background-color', themeColors.highlightBgColor).animate({
            backgroundColor: themeColors.bgColor
        },
            2000);
    }
...
function createSidebar(element, sidebarModel, activeId) {
    ...
    element.treeview({
        ...
        enableLinks: true,
        showBorder: false,
        color: themeColors.treeViewColor,
        backColor: themeColors.treeViewBackColor,
        selectedColor: themeColors.treeViewSelectedColor,
        selectedBackColor: themeColors.treeViewSelectedBackColor,
        onhoverColor: themeColors.treeViewOnHoverColor,
