...
namespace ITGlobal.MarkDocs.Site.Extensions
{
    public static class ImageRenderer
    {
        ...
        private static void RenderOneImage(HtmlRenderer renderer, LinkInline link)
        {
            ...
            var html = RazorViewRenderer.Render(Startup.ApplicationServices, "~/Views/Render/Image.cshtml", model);
            renderer.Write(html);
        }
        ...
        private static void RenderImageGallery(HtmlRenderer renderer, List<LinkInline> sublings)
        {
            ...
            var html = RazorViewRenderer.Render(Startup.ApplicationServices, "~/Views/Render/ImageGallery.cshtml", model);
            renderer.Write(html);
        }
